...
- Your app's Fluent theme, light or dark. The current package includes English and German; see the [language details](docs/faq.md#languages). Times follow each user's time zone.
